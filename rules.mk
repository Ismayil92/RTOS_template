...
TGT_CPPFLAGS += -MD
TGT_CPPFLAGS += -Wmissing-prototypes -Wall -Wundef $(INCLUDES)
...
TGT_CFLAGS += -Wextra -Wshadow -Wno-unused-variable -Wimplicit-function-declaration -Wuninitialized
...
.SUFFIXES:
.SUFFIXES: .c .S .h .o .cxx .elf .bin .list .lss .cpp
...
#		-c "program $(realpath $(BUILD_DIR)/$(*).elf) verify reset exit" \
#		$(NULL)
#else
#	$(Q)(echo "halt; program $(realpath $(BUILD_DIR)/$(*).elf) verify reset" | nc -4 localhost 4444 2>/dev/null) || \
#		$(OOCD) -f $(OOCD_FILE) \
